                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <form method="post" name="frm_home" id="frm_home" action="atualizar_homeEN.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_frase" value="<?php echo $dadosHome['hom_fraseEN']; ?>" name="txt_frase" class="form-control" placeholder="Digite uma frase de destaque">
                                        </div>
                                        <div class="card-body">
                                            <a href="#" class="card-link">
                                                <button name="btn_enviar" type="submit" onclick=" return validar_dados();" class="btn btn-success">Atualizar</button>
                                            </a>
                                            <a href="consulta_homeEN.php" class="card-link">
