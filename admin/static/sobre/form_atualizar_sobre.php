                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <form method="post" name="frm_sobre" id="frm_sobre" action="atualizar_sobre.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_titulo" value="<?php echo $dadosSobre['sob_titulo']; ?>" name="txt_titulo" class="form-control" placeholder="Digite uma frase de destaque">
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Texto 1</h5> </br>
                                            <input type="text" id="txt_texto1" value="<?php echo $dadosSobre['sob_texto1']; ?>" name="txt_texto1" class="form-control" placeholder="Digite uma frase de destaque">
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Texto 2</h5> </br>
                                            <input type="text" id="txt_texto2" value="<?php echo $dadosSobre['sob_texto2']; ?>" name="txt_texto2" class="form-control" placeholder="Digite uma frase de destaque">
                                        </div>
                                        <div class="card-body">
                                            <a href="#" class="card-link">
                                                <button name="btn_enviar" type="submit" onclick=" return validar_dados();" class="btn btn-success">Atualizar</button>
                                            </a>
                                            <a href="consulta_sobre.php" class="card-link">
