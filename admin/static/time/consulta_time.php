                                    ...
                                    <tbody>
                                        <?php while ($dadosTimeGeral = mysqli_fetch_array($sqlTimeGeral)) { ?>
                                            <tr>
                                                ...
                                                <td >
                                                    <a style="padding-left: 35%;" href="form_atualizar_timeG.php?tim_codigo=<?php echo $dadosTimeGeral['timG_codigo']; ?>" class="card-link">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="form_atualizar_time.php?tim_codigo=<?php echo $dadosTime['tim_codigo']; ?>" class="card-link">
                                            <span class="align-middle">Editar</span>
                                            <i class="align-middle" data-feather="edit"></i>
                                        </a>
                                    </div>
