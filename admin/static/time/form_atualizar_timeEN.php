                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <form method="post" name="frm_time" id="frm_time" action="atualizar_timeEN.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_especialidade" value="<?php echo $dadosTime['tim_especialidadeEN']; ?>" name="txt_especialidade" class="form-control" placeholder="Digite a especialidade">
                                        </div>
                                        <div class="card-header">
