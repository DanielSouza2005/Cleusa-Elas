									...
									<tbody>
										<?php while ($dadosGaleriaGeral = mysqli_fetch_array($sqlGaleriaGeral)) { ?>
											<tr>
                                                ...
                                                <td >
                                                    <a style="padding-left: 50%;" href="form_atualizar_galeriaG.php?gal_codigo=<?php echo $dadosGaleriaGeral['galG_codigo']; ?>" class="card-link">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="form_atualizar_galeria.php?gal_codigo=<?php echo $dadosGaleria['gal_codigo']; ?>" class="card-link">
                                            <span class="align-middle">Editar</span>
                                            <i class="align-middle" data-feather="edit"></i>
                                        </a>
                                    </div>
