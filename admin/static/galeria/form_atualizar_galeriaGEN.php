                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <form method="post" name="frm_galeria" id="frm_galeria" action="atualizar_galeriaGEN.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_titulo" value="<?php echo $dadosGaleria['galG_tituloEN']; ?>" name="txt_titulo" class="form-control" placeholder="Digite um serviço">
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Descrição</h5> </br>
                                            <input type="text" id="txt_descricao" value="<?php echo $dadosGaleria['galG_descricaoEN']; ?>" name="txt_descricao" class="form-control" placeholder="Digite uma descrição">
                                        </div>
                                        <div class="card-body">
