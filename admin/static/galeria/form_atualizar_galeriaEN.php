                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <form method="post" name="frm_galeria" id="frm_galeria" action="atualizar_galeriaEN.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_servico" value="<?php echo $dadosGaleria['gal_servicoEN']; ?>" name="txt_servico" class="form-control" placeholder="Digite o serviço">
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Especificação</h5> </br>
                                            <input type="text" id="txt_especificacao" value="<?php echo $dadosGaleria['gal_especificacaoEN']; ?>" name="txt_especificacao" class="form-control" placeholder="Digite a especialidade">
                                        </div>
                                        <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="consulta_galeriaEN.php" class="card-link">
