                                    ...
                                    <tbody>
                                        <?php while ($dadosServicosGeral = mysqli_fetch_array($sqlServicosGeral)) { ?>
                                            <tr>
                                                ...
                                                <td >
                                                    <a style="padding-left: 50%;" href="form_atualizar_servicosG.php?ser_codigo=<?php echo $dadosServicosGeral['serG_codigo']; ?>" class="card-link">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="form_atualizar_servicos.php?ser_codigo=<?php echo $dadosServicos['ser_codigo']; ?>" class="card-link">
                                            <span class="align-middle">Editar</span>
                                            <i class="align-middle" data-feather="edit"></i>
                                        </a>
                                    </div>
