                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <form method="post" name="frm_contato" id="frm_contato" action="atualizar_contatoEN.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <input type="text" id="txt_endereco" value="<?php echo $dadosContato['con_enderecoEN']; ?>" name="txt_endereco" class="form-control" placeholder="Digite o endereço">
                                        </div>
                                        <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="consulta_contatoEN.php" class="card-link">
