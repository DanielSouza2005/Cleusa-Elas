...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.php">
				...
				<img style="padding-bottom: 4%;" src="images/logo.png" class="menu_logo" width="200px">
			</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;
					<a class="navbar-brand menu-acesso" target="_blank" href="admin/static/login.php">
	...
	<section class="hero-wrap js-fullheight" id="home" style="background-image: url(admin/static/home/<?php echo $dadosHome['hom_foto']; ?>);" data-stellar-background-ratio="0.5">
			...
			<div class="row no-gutters slider-text js-fullheight justify-content-center align-items-center">
				<div class="col-lg-12 ftco-animate d-flex align-items-center">
					<div class="text text-center">
						...
						<p style="color:#fff; font-size: 22px;">Cabelo e Estética</p>
						<p><a href="#about" class="btn btn-primary btn-outline-primary px-4 py-2">Saiba Mais</a></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-md-6 py-md-5 pb-5 wrap-about pb-md-5 ftco-animate fadeInUp ftco-animated">
						<div class="heading-section mb-4 mt-md-5">
							<h2 class="mb-4"><?php echo $dadosSobre['sob_titulo']; ?></h2>
						</div>
						<div class="pb-md-5">
							<p style="text-align: justify; text-justify: inter-word;"><?php echo $dadosSobre['sob_texto1']; ?>
							</p>
							<p style="text-align: justify; text-justify: inter-word;"><?php echo $dadosSobre['sob_texto2']; ?>
							</p>
						</div>
					</div>
				</div>
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb corFundo" id="gallery">
			...
			<!--<section class="ftco-section ftco-booking bg-light corFundo" id="booking">
